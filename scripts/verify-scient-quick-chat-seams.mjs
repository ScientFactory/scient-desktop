...
const MANIFEST_PATH = "scient-quick-chat-seams.json";
const SOURCE_ROOTS = [
  "apps/mobile/src",
  "apps/server/src",
  "apps/web/src",
...
export function verifyScientQuickChatSeams() {
  ...
  process.stdout.write(
    `Scient Quick Chat seam check passed: ${String(mountPaths.size)} mounts, ${String(observed.length)} reviewed projectless decision paths.\n`,
  );
}

if (import.meta.main) verifyScientQuickChatSeams();
