...
// Keep the preview warning in the release name, but retain Scient branding.
// The release name is the first thing a maintainer sees before the body.
...
export const resolveNightlyReleaseMetadata = (
  ...
  return {
    ...
    version,
    tag: `v${version}`,
    name: `Scient ${CHANNEL_RELEASE_LABELS[channel]} ${version} (${shortSha})`,
    shortSha,
  };
};
