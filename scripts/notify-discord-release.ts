  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Scient prerelease is available for nightly testers."
          : "A new Scient latest release is available.",
...
).pipe(Command.withDescription("Post a Scient release announcement to Discord."));
