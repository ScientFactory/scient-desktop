...
if command -v npx >/dev/null 2>&1; then
  require_installed_t3_cli npx --yes --allow-scripts=@@T3_ALLOWED_SCRIPTS@@ --package @@T3_PACKAGE_SPEC@@ || exit 1
  exec npx --yes --allow-scripts=@@T3_ALLOWED_SCRIPTS@@ --package @@T3_PACKAGE_SPEC@@ t3 "$@"
fi
if command -v npm >/dev/null 2>&1; then
  require_installed_t3_cli npm exec --yes --allow-scripts=@@T3_ALLOWED_SCRIPTS@@ --package @@T3_PACKAGE_SPEC@@ || exit 1
