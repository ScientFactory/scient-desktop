...
export const WS_METHODS = {
  ...
  serverRepairProvider: "server.repairProvider",
  serverRollbackProvider: "server.rollbackProvider",
  serverRemoveManagedProvider: "server.removeManagedProvider",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.serverDisconnectProvider, ServerProviderDisconnectInput),
  tagRequestBody(
  ...
  tagRequestBody(WS_METHODS.serverRepairProvider, ServerProviderRuntimeMutationInput),
  tagRequestBody(WS_METHODS.serverRollbackProvider, ServerProviderRuntimeMutationInput),
  tagRequestBody(WS_METHODS.serverRemoveManagedProvider, ServerProviderRuntimeMutationInput),
