...
const RuntimeEventRawSource = Schema.Union([
  ...
  Schema.Literal("antigravity.cli.stream-json"),
...
// Keep the public discriminant alias used by Scient’s contract tests and
// downstream consumers while deriving it from the current event union.
export type ProviderRuntimeEventType = ProviderRuntimeEventV2["type"];
