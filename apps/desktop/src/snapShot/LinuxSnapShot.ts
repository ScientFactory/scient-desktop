...
const EXTENSION = "org.gnome.Shell.Extensions.ScientSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/ScientSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Scient instance is capturing a window. Try again.");
    }
