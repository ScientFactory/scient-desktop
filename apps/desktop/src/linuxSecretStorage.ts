...
function getGnomeKeyringRemediationMessage(): string {
  return "Scient could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Scient.";
}

function getKWalletRemediationMessage(): string {
  return "Scient could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Scient.";
}
