...
const PREVIEW_PARTITION_PREFIX = SCIENT_DESKTOP_IDENTITY.previewPartitionPrefix;
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = SCIENT_DESKTOP_IDENTITY.previewEphemeralPartitionPrefix;
