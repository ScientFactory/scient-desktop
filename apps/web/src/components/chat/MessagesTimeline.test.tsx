...
describe("MessagesTimeline", () => {
  ...
  it("renders elapsed time for a completed turn", () => {
    ...
    const assistantEntry = buildAssistantTimelineEntry({ text: "Done." });
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        {...buildProps()}
        latestTurn={{
    ...
    const completedAssistant = renderToStaticMarkup(
      <MessagesTimeline
        ...
        timelineEntries={[
          ...
          buildUserTimelineEntry("Start the next turn"),
        ]}
  ...
  it("continues to render sanitized raw HTML in assistant messages", async () => {
    ...
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        ...
        timelineEntries={[
          buildAssistantTimelineEntry({
            text: "<details><summary>More</summary>Details</details>",
          }),
        ]}
      />,
    );
  ...
  it.each(
    ...
    async ({ markdown, expected, strongCount, streaming }) => {
      ...
      const thought = buildAssistantTimelineEntry({ text: markdown });
      let renderer: ReactTestRenderer | undefined;
      try {
        await act(() => {
          renderer = create(
