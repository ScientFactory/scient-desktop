        ...
        >
          ...
          >
            ...
            <SelectValue data-composer-control-label>
              ...
              !props.supportedRuntimeModes.includes(props.runtimeMode)
                ? "Choose access"
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const effectiveSelectedProviderSkills = useMemo(
    ...
    [scientSkills, selectedProvider, selectedProviderSkills],
  );
  ...
  const onComposerCommandKey = (
    ...
    if (submissionIntent) {
      ...
      // it does not mirror queued payloads in browser state.
      const steer =
        routeKind === "server" &&
