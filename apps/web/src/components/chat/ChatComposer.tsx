...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const fileStagingLimit = SCIENT_GENERIC_FILE_ATTACHMENTS_ENABLED
    ? fileAttachmentStagingLimit({
        attachmentUploadsCapabilityKnown,
        supportsAttachmentUploads,
        maxFileAttachmentBytes,
  ...
  const fileCapabilityBlockReason =
    !SCIENT_GENERIC_FILE_ATTACHMENTS_ENABLED && composerFiles.length > 0
      ? "Generic file attachments are temporarily unavailable. Remove the files to send."
      : fileAttachmentCapabilityBlockReason({
          files: composerFiles,
          attachmentUploadsCapabilityKnown,
          supportsAttachmentUploads,
