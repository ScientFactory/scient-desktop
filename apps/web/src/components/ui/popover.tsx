...
const popoverViewportPaddingClassName = {
  ...
  comfortable: "p-3 [--viewport-inline-padding:--spacing(3)]",
  compact: "py-2 [--viewport-inline-padding:--spacing(3)]",
  tight: "p-2 [--viewport-inline-padding:--spacing(2)]",
...
function PopoverPopup({
  ...
  /** Local content-layout hook for popovers whose body owns its own padding. */
...
function PopoverTitle({
  ...
  size = "default",
  ...props
}: PopoverPrimitive.Title.Props & { size?: "default" | "compact" }) {
  return (
...
function PopoverDescription({
  ...
  size = "default",
  ...props
}: PopoverPrimitive.Description.Props & { size?: "default" | "compact" }) {
  return (
