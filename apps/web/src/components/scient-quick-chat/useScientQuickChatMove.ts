...
import { resolveScientQuickChatMoveProgress, type ScientQuickChatPendingMove } from "./moveState";
 ...
 */
export function useScientQuickChatMove(input: {
  ...
  const [pendingMove, setPendingMove] = useState<ScientQuickChatPendingMove | null>(null);
