    ...
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <WizardHeader
          title="Set up Scient"
          identity={
            <div className="flex items-baseline gap-1.5" role="img" aria-label="Scient">
              <span className="shrink-0 font-semibold">Scient</span>
              <span className="text-xl-scient font-medium tracking-tight text-muted-foreground">
                Code
              </span>
            </div>
          }
        ...
        <CollapsiblePanel keepMounted>
          <div className="px-3 pb-3">
            ...
            <p className="text-sm text-muted-foreground">
              Use the Scient server archive from your release as SCIENT_SERVER_PACKAGE on each
              computer.
            </p>
            <CommandBlock
              command={'npx --package="$SCIENT_SERVER_PACKAGE" t3 connect'}
              className="mt-3"
            />
            <p className="mt-3 text-xs text-muted-foreground">
              Keep Scient running. Select the computers you want to set up above.
            </p>
          </div>
        </CollapsiblePanel>
      </Collapsible>
        ...
        <Collapsible>
          ...
          <CollapsiblePanel>
            <p className="pt-3 text-sm text-muted-foreground">
              Use the Scient server archive from your release as SCIENT_SERVER_PACKAGE on the
              computer with your code.
            </p>
            <CommandBlock
              command={'npx --package="$SCIENT_SERVER_PACKAGE" t3 pair'}
              className="mt-2"
            />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Scient first. You can also create a pairing link in Settings → Connections on
              that computer.
            </p>
          </CollapsiblePanel>
        </Collapsible>
