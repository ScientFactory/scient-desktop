    ...
    <div className="space-y-8">
      ...
      <SettingsSection title="Portable skills">
        <SettingsRow
          ...
          description="Skills placed here are available on every provider. When a provider already ships its own copy of a skill, that copy is used; otherwise Scient's copy is the fallback."
          status={
            synaraSkillsDir ? (
      ...
      {catalogQuery.isError ? (
        <SettingsSection title="Skills">
          <SettingsRow
            ...
            description="Scient could not scan the skill folders. Retry after checking that the server is running."
          />
        </SettingsSection>
      ) : null}
      ...
      scientBuiltInSkills.length === 0 ? (
        <SettingsSection title="Skills">
          <SettingsRow
            ...
            description="Add a skill folder containing a SKILL.md to the Scient skills folder above, or install skills for any supported provider."
          />
        </SettingsSection>
      ) : null}
