...
export const make = Effect.gen(function* () {
  ...
  const sweep = Effect.fn("ThreadSettlementReactor.sweep")(function* (
    ...
    // not linked yet. Those lookups can still have cached the PR as open. A thread-scoped
    // event can stay narrow, while the periodic and merge-triggered sweeps remain global.
