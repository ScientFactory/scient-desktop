...
export const make = Effect.gen(function* () {
  ...
  // Compare configured and canonical spellings. On macOS /var is itself a
  // symlink, so resolving only the candidate misses managed /private/var roots.
  const managedRoots = yield* Effect.forEach([baseDir, worktreesDir], (directory) =>
