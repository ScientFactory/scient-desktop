/**
 * Scient owns the product decision to offer Quick Chat. The wire field keeps
 ...
 */
export const SCIENT_QUICK_CHAT_SERVER_CAPABILITIES = {
  projectlessThreads: true,
} as const;

/** Product-facing fallback used by server-originated activity surfaces. */
export const SCIENT_QUICK_CHAT_SERVER_LABEL = "Quick chat";
