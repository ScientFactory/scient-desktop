import {
  QUICK_CHAT_MOVE_TERMINALS_OPEN,
 ...
 */
export const ensureScientQuickChatMoveHasNoRunningTerminals = Effect.fn(
  "ScientQuickChat.ensureMoveHasNoRunningTerminals",
)(function* (input: {
  ...
  return yield* new OrchestrationDispatchCommandError({
    message: `${QUICK_CHAT_MOVE_TERMINALS_OPEN}: Close every terminal for this chat before moving it to a project.`,
  });
});
