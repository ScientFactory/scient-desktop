...
import { normalizeScientThreadCreateTarget, validateScientQuickChatMove } from "./Policy.ts";
...
describe("Scient Quick Chat server policy", () => {
  it("normalizes Quick Chat to the environment workspace without project metadata", () => {
    expect(
  ...
  it("accepts only a stopped, idle Quick Chat and active destination", () => {
    expect(
