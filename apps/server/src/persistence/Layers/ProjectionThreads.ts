    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.forkTitleFamilyRootId ?? null},
          ${row.forkTitleBase ?? null},
          ${row.forkTitleOrdinal ?? null},
        ...
        DO UPDATE SET
          ...
          fork_title_family_root_id = excluded.fork_title_family_root_id,
          fork_title_base = excluded.fork_title_base,
          fork_title_ordinal = excluded.fork_title_ordinal,
