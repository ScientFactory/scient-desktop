...
export const MAX_AUTOMATION_CONTEXT_RECEIPTS_PER_PROPOSAL = 16;
export const MAX_EVIDENCE_RECEIPTS_PER_PROPOSAL = 128;
export const MAX_EVIDENCE_RECEIPTS_PER_VERIFICATION = 128;
export const MAX_VERIFICATION_RECEIPTS_PER_MANUAL_DECISION = 64;
