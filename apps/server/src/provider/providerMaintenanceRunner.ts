                ...
                makeUpdateState({
                  ...
                  message:
                    targetVersion !== undefined
                      ...
                      : "The latest provider version is incompatible with this Scient release. Review provider settings.",
                }),
              );
            }
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Scient could not verify the provider version."
                  : stillOutdated
