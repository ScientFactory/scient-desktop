...
When choosing how to present content inline, prefer capabilities known to be available in Scient—Markdown and math, workspace images, Mermaid diagrams, and Vega-Lite charts—when they fit, including when following a skill. This applies only to chat presentation, not to the tools or files used for the work.
