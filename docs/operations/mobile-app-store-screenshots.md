...
runs iOS and Android concurrently on standard GitHub-hosted macOS and Linux runners. Android phone,
7-inch tablet, and 10-inch tablet capture uses a KVM-accelerated x86_64 emulator.
