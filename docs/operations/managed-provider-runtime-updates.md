...
Codex contract 3 accommodates the official voice payload and newer Windows
packages: Unix archives use a reviewed allowance of 128 entries; Windows uses
64 entries; both retain the 512 MiB expanded-data limit. The shared extraction
default remains 32 entries for other providers. Changing these Codex-specific
