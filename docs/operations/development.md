...
including services unrelated to Scient. If you run untrusted services on that hostname, keep
...
startup and keeps its own SQLite data, signing key, and revocation state. Desktop and non-development
