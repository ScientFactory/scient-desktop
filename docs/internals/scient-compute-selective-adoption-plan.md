...
| Compact Scientific Computing settings | Adopt                 | One current-runtime row per language and a collapsed Runtime recovery area. No inventory dashboard or explanatory card stack.                                                                                                                         |
...
| Test passed state                     | Adopt with correction | Bind proof to the runtime fingerprint and meaningful server status. Clear it on refresh, selection, generation, enablement, or health changes; identical polling responses preserve it. Invalidated tests and late replies cannot revive stale proof. |
| Runtime repair                        | Narrow                | Repair only a broken selected Scient-managed generation. A broken user-owned runtime opens Runtime and remains user-owned.                                                                                                                            |
