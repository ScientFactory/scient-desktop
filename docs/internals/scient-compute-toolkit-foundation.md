...
| UI                            | Settings → Scientific Computing shows one current runtime per language; Change runtime is a picker                                                  | File header names the probed interpreter; **ready** is reserved for a live session. Repair is for a damaged managed generation, not a skipped Test.                    |
