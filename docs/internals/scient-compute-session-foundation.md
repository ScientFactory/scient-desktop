...
| Stable rebased candidate                       | The complete qualification checkpoint `fcf7c22fab` contains `origin/main` snapshot `015bfd8cda` in its ancestry. Current-main integration, local qualification, and all currently configured required hosted checks are proven for that snapshot; later-main integration remains a moving release gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Stable and locally/hosted qualified           |
...
| Packaged cross-platform and release acceptance | The rebased tree passes local production web, desktop, and server builds, exact bridge staging, release smoke, and Electron smoke. All currently configured required hosted checks pass exact head `fcf7c22fab`. The release-qualification track's installed-app tests on supported platforms, future-main integration, and explicit release approval remain.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Local/hosted assembly passed; release pending |
