...
documentation checkpoint before this closeout is `ed7bb17db9`. The settings,
...
| Stable rebased candidate                       | The complete candidate through documentation checkpoint `70e7626582` contains `origin/main` snapshot `015bfd8cda` in its ancestry. Current-main integration and local qualification are proven for that snapshot; later-main integration remains a moving release gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Stable and locally qualified                            |
