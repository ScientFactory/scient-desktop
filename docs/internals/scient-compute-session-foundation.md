...
replay and focused structural checks remained green. This evidence-ledger
closeout still requires its own hosted checks. Evidence is always exact-
snapshot evidence: no result qualifies Windows or a later rebased head.
