...
Recognized Scient tools use descriptive labels in both the running summary and individual rows.
...
Preview browser actions use a globe icon. Other Scient tools keep the Scient mark.
