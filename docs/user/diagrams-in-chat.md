...
and contains source, copy, download, and retry actions. Source inspection opens
on request, or automatically when a diagram fails. Expanded viewers keep zoom,
fit, and actual-size controls visible.
