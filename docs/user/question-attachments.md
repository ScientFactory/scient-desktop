...
Forking a completed response preserves submitted question answers and their files through that
response. The fork owns independent copies, so deleting the original conversation does not remove
them. Unsubmitted question drafts and later answers stay outside the retained history. Provider
context limits still apply: older context or files may be omitted from the first provider request
while remaining available in the fork's history.
